...
namespace UniExt
{
    public static class ListExtensions
    {
        ...
        public delegate void _EachAction<in T>(T value, ref bool doBreak);

        public delegate void _EachActionIterate<in T>(T value, int i, ref bool doBreak);
        ...
        public static int _Sum(this IList<int> source)
        {
            int i = 0;
        ...
        public static float _Sum(this IList<float> source)
        {
            float i = 0;
        ...
        public static IEnumerable<int> _Cast(this IEnumerable<float> source)
        {
            foreach (var item in source)
                yield return Convert.ToInt32(item);
        }

        public static IEnumerable<float> _Cast(this IEnumerable<int> source)
        {
            foreach (var item in source)
        ...
        public static void _Save(this IEnumerable<string> list, string path)
        {
